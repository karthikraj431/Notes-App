...
const Home = () => {
  ...
  const [isSidebarOpen, setSidebarOpen] = useState(false); // Track sidebar state
  ...
  // Logged-in user homepage with sidebar space
  return (
    <div className="flex min-h-screen">
      ...
      {/* Main content */}
      <div
        className={`flex-1 p-4 grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-300`}
